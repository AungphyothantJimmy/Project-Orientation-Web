...
namespace ProjectQuiz.Controllers
{
    ...
    public class ProjectMembersController : Controller
    {
        ...
        public async Task<IActionResult> Create(int projectId)
        {
            ...
            // Filter users with the "member" role
            var memberUsers = _context.Users
                .Where(u => u.Role == "member")
                .Select(u => new SelectListItem
                {
                    Value = u.Id.ToString(),
                    Text = u.Username // Assuming Username is a property
                })
                .ToList();

            // Pass filtered users and project ID to the view
